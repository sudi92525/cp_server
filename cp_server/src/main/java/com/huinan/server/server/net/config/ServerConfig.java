...
public class ServerConfig {
	...
	public String getAdminInitUrl() {
		return config.getString("GameServer.GameInitUrl", "http://192.168.1.4:8081/api/GetInitData");
	}
	
	public String getAdminLoginUrl() {
		return config.getString("GameServer.LoginApiUrl", "http://192.168.1.4:8081/api/Account/Logon");
	}
